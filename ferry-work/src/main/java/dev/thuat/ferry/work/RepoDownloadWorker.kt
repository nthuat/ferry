 ...
 * [dev.thuat.ferry.SpaceReport]), [VerificationException] (names a path), or a bare
...
class RepoDownloadWorker(
    ...
    companion object {
        /** Required input: the repo id to download — see [dev.thuat.ferry.Ferry]. */
        ...
        /** Output on [REASON_INSUFFICIENT_SPACE]: [dev.thuat.ferry.SpaceReport.requiredBytes]. */
        const val KEY_REQUIRED_BYTES = "requiredBytes"

        /** Output on [REASON_INSUFFICIENT_SPACE]: [dev.thuat.ferry.SpaceReport.freeBytes]. */
        const val KEY_FREE_BYTES = "freeBytes"

        /** Output on [REASON_INSUFFICIENT_SPACE]: [dev.thuat.ferry.SpaceReport.shortfallBytes]. */
